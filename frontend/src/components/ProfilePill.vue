<template>
  ...
  >
    ...
    <div v-if="showDropdown" class="dropdown-content">
      ...
      <router-link to="/photochart" class="dropdown-link"
        >Trombinoscope</router-link
      >
      <router-link to="/assolist" class="dropdown-link"
        >Associations</router-link
      >
      <button v-if="user.user_type == 'admin'" @click="goToAdminControls">
        Manage students
      </button>
      <button
        v-if="user.user_type == 'asso' || user.user_type == 'admin'"
        @click="goToAssoControls"
      >
        Manage events
      </button>
