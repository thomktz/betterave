...
[data-dark-mode="true"] .dark-mode-toggle {
  border-color: white;
}

[data-dark-mode="true"] .sun {
  opacity: 0;
}

[data-dark-mode="true"] .moon {
  opacity: 1;
}
[data-dark-mode="true"] .dark-mode-toggle:hover .sun {
  opacity: 1;
}

[data-dark-mode="true"] .dark-mode-toggle:hover .moon {
  opacity: 0;
}
</style>
