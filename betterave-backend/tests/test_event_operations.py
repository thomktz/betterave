...
def test_get_association_events(test_client, setup_asso, setup_event):
...
def test_get_user_events(test_client, setup_student, setup_event):
...
def test_get_association_future_events(test_client, setup_asso, setup_event):
...
def test_get_user_future_events(test_client, setup_student, setup_event):
