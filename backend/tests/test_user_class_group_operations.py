...
from app.models.user_class_group import UserClassGroup
...
def setup_primary_class_group(test_client, setup_class):
    ...
    primary_class_group_id = add_class_group(
...
def setup_secondary_class_group(test_client, setup_class):
    ...
    secondary_class_group_id = add_class_group(
...
def test_modify_user_class_group(setup_user_class_group):
    ...
    assert modify_user_class_group(setup_user_class_group, {'secondary_class_group_id': NEW_SECONDARY_GROUP_ID}) is True
