...
class_group_model = api.model(
    "ClassGroup",
    {
        ...
        "is_main_group": fields.Boolean(
            default=False,
            description="Indicates if this is the main group for the class",
        ),
    },
)

sender_details_model = api.model(
    "SenderDetails",
    {
...
message_model = api.model(
    "Message",
    {
        ...
        "group_id": fields.Integer(
            required=True,
            description="The identifier of the class group associated with the message",
        ),
        ...
        "sender_details": fields.Nested(
            sender_details_model,
            description="The details of the user who posted the message",
        ),
    },
)
