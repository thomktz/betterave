...
user_class_group_model = api.model("UserClassGroup", {
    "id": fields.Integer(readonly=True, description="Unique identifier of the user-class group relationship"),
...
user_class_group_update_model = api.model("UpdateUserClassGroup", {
