...
lesson_post_model = api.model("LessonPost", {
    ...
    "date": fields.Date(
        required=True, 
        description="The date on which the lesson will take place"
    ),
    ...
    "room": fields.String(
        description="The room in which the lesson is scheduled to take place"
    ),
    "teacher_id": fields.Integer(
        description="The identifier of the teacher conducting the lesson"
    ),
    "homework": fields.String(
        description="Any homework assigned for this lesson"
    ),
})
